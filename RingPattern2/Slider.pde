...
/*
slider = createSlider(0, 100, 1); //slides from 0 to 100 in 1er steps
slider = createSlider(0, 1, -1);  //slides from 0 to 1 in how many steps the pixel resolution allows

drawSliders(); //call in draw method
